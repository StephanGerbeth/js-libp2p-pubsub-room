...
const directConnection = require('./direct-connection-handler.js')
const uint8ArrayFromString = require('uint8arrays/from-string.js')
const uint8ArrayToString = require('uint8arrays/to-string.js')
